...
- If you'd like to introduce 3rd-party dependencies, please contribute to [@velocity1/vueuse-integrations](https://github.com/vueuse/vueuse/tree/main/packages/integrations) or create a new add-on.
