...
```ts
import { TransitionPresets, useTransition } from '@velocity1/vueuse-core'
...
```ts
import { useTransition } from '@velocity1/vueuse-core'
// ---cut---
...
```ts
import { transition } from '@velocity1/vueuse-core'
